...
import com.example.xiaojin20135.basemodule.layout.LayoutInf;
import com.example.xiaojin20135.basemodule.view.widget.alpha.AlphaViewHelper;

public class RadiusImageView2 extends AppCompatImageView implements LayoutInf {
    ...
    public RadiusImageView2(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.RadiusImageView2, defStyleAttr, 0);

        mBorderWidth = array.getDimensionPixelSize(R.styleable.RadiusImageView2_border_width, 0);
        mBorderColor = array.getColor(R.styleable.RadiusImageView2_border_color, DEFAULT_BORDER_COLOR);
        mSelectedBorderWidth = array.getDimensionPixelSize(
                R.styleable.RadiusImageView2_selected_border_width, mBorderWidth);
        mSelectedBorderColor = array.getColor(
                R.styleable.RadiusImageView2_selected_border_color, mBorderColor);
        mSelectedMaskColor = array.getColor(
                R.styleable.RadiusImageView2_selected_mask_color, Color.TRANSPARENT);
        ...
        mIsTouchSelectModeEnabled = array.getBoolean(
                R.styleable.RadiusImageView2_is_touch_select_mode_enabled, true);
        mIsCircle = array.getBoolean(R.styleable.RadiusImageView2_is_circle, false);
        if (!mIsCircle) {
            setRadius(array.getDimensionPixelSize(
                    R.styleable.RadiusImageView2_corner_radius, 0));
        }
        array.recycle();
    }
