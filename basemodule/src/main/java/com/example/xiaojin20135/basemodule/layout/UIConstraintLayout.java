...
import com.example.xiaojin20135.basemodule.view.widget.alpha.AlphaConstraintLayout;

public class UIConstraintLayout extends AlphaConstraintLayout implements LayoutInf {
    ...
    /*
    * @author lixiaojin
    * create on 2020-03-06 16:56
    * description: 重写测量view大小的函数
    */
    @Override
