package com.example.xiaojin20135.basemodule.view.widget.textview;
...
import com.example.xiaojin20135.basemodule.view.widget.link.LinkTouchMovementMethod;

public class SpanTouchFixTextView extends AppCompatTextView implements ISpanTouchFix, LayoutInf {
    /**
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        mTouchSpanHit = true;
        // 调用super.onTouchEvent,会走到LinkTouchMovementMethod
        // 会走到LinkTouchMovementMethod#onTouchEvent会修改mTouchSpanHint
